...
class APODArchiveImplementation : APODArchiveRepository {
    override suspend fun getAPODArchiveData(startDate: String, endDate: String): List<APODDTO> {
        return HTTPClient.ktorClient.get("https://api.nasa.gov/planetary/apod?api_key=bCUlmKS9EpyQ1ChMIUnsglSTGTwQy1CdLhLP4FCL&start_date=$endDate&end_date=$startDate")
            .body()
    }
}