...
fun OpportunityMainRoverScreen() {
    ...
    val opportunityCamerasVM: OpportunityCamerasVM = viewModel()
    ...
    AppTheme {
        Column {
            LazyColumn(
                ...
                stickyHeader {
                    ScrollableTabRow(
                        ...
                        opportunityCamerasVM.opportunityRoverCameras.forEachIndexed { index, camera ->
                            Tab(
            ...
            HorizontalPager(count = opportunityCamerasVM.opportunityRoverCameras.size, state = pagerState) { page->
                opportunityCamerasVM.opportunityRoverCameras[page].composable()
            }
        }
